...
.DESCRIPTION
Hyper-V Toolbox is a PowerShell-based solution designed to streamline and simplify virtual machine (VM) management on Windows using Hyper-V. 
It offers an intuitive, interactive interface for handling complex VM operations with ease — making VM provisioning, configuration, and management as seamless as working with containers.

.PARAMETER -help
Displays the help menu for Hyper-V Toolbox, detailing available commands and usage.

.INPUTS
None. All inputs are gathered interactively through user prompts.

.OUTPUTS
Text-based outputs to the console, providing real-time feedback and details about VM management operations.
...
.LICENSE
Distributed under the GNU Affero General Public License v3.0. See [LICENSE](https://github.com/franckferman/Hyper-V-Toolbox/blob/stable/LICENSE) for full license details.

.CREDITS
Inspired by [Docker](https://www.docker.com/) and [Vagrant](https://www.vagrantup.com/).

.EXAMPLE
PS > Set-ExecutionPolicy -ExecutionPolicy Unrestricted -Scope Process; .\HyperV-Toolbox.ps1
...
[System.Uri]$Script:Blank_Windows_JSON_LinksFile = 'https://raw.githubusercontent.com/franckferman/Hyper-V-Toolbox/stable/assets/links/blank_windows.json'
[System.Uri]$Script:Blank_Linux_JSON_LinksFile = 'https://raw.githubusercontent.com/franckferman/Hyper-V-Toolbox/stable/assets/links/blank_linux.json'
# [System.Uri]$Script:Preconfigured_Windows_JSON_Links_File = 'https://raw.githubusercontent.com/franckferman/Hyper-V-Toolbox/stable/assets/links/preconfigured_windows.json'
# [System.Uri]$Script:Preconfigured_Linux_JSON_Links_File = 'https://raw.githubusercontent.com/franckferman/Hyper-V-Toolbox/stable/assets/links/preconfigured_linux.json'
...
function Display-Help {
    ...
    <#
    .SYNOPSIS
    Displays help information for Hyper-V Toolbox.
...
USAGE:
Just run the script to start interacting with Hyper-V.
...
function Get-WANStatus {
    ...
    try {
        ...
        $response = Invoke-WebRequest -Uri $selectedUrl -WebSession $webSession -Headers @{
            'User-Agent' = 'Hyper-V-Toolbox/1.0.0'
...
function Get-Update {
    ...
    param (
        [Parameter(Mandatory=$false)]
        [System.Uri]$repositoryUrl = 'https://raw.githubusercontent.com/franckferman/Hyper-V-Toolbox/stable/HyperV-Toolbox.ps1'
    )
...
|PS C:\Users\$env:USERNAME> .\HyperV-Toolbox.ps1                           | |
|                                                                     |_|
